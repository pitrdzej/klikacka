...
.stage.prestige-active::after {
  ...
  inset: 0;
  pointer-events: none;
  background: radial-gradient(circle at 30% 18%, rgba(255,200,140,0.06), transparent 12%), radial-gradient(circle at 80% 78%, rgba(255,120,180,0.04), transparent 10%);
  z-index: 6;
}
...
@keyframes particleFloat {
  ...
  10% { opacity: 1; }
  50% { transform: translate3d(var(--dx, 0px), var(--dy, -120px), 0) scale(1); opacity: 0.9; }
  100% { opacity: 0; transform: translate3d(var(--dx, 0px), var(--dy, -200px), 0) scale(0.8); }
}

.stage-particles .particle:nth-child(odd) { background: radial-gradient(circle, rgba(255,200,100,0.98), rgba(255,95,140,0.85)); }
.stage-particles .particle:nth-child(even) { background: radial-gradient(circle, rgba(255,240,170,0.9), rgba(255,140,180,0.85)); }
